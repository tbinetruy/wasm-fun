(module
 ...
 (func $nth_car (param $list_addr i32) (param $n i32) (result i32)
       (get_local $list_addr)
       (get_local $n)
       (call $find_nth_element)
       (call $car))

 (func $nth_cdr (param $list_addr i32) (param $n i32) (result i32)
       (get_local $list_addr)
       (get_local $n)
       (call $find_nth_element)
       (call $cdr))

 (func $nth_car_addr (param $list_addr i32) (param $n i32) (result i32)
       (get_local $list_addr)
       (get_local $n)
       (call $find_nth_element)
       (call $car_addr))

 (func $nth_cdr_addr (param $list_addr i32) (param $n i32) (result i32)
       (get_local $list_addr)
       (get_local $n)
       (call $find_nth_element)
       (call $cdr_addr))
